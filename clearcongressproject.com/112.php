...
<small>currently desplaying data based on 112th session. <a href="http://clearcongressproject.com/" title="Clear Congress Project 112th session">click here for the current 113th session</a></small>
  </div>
</div>
<div class="container">
  <div class="row">
  ...
  <div class="footer">
    <p>&copy; 2013 <a href="http://flavors.me/tomgibes" target="_blank">Thomas Gibes</a></p>
...
getIdeology(1);
	...
	var total_pages = 250; // currently this is manually updated - need to utilize count within the RTC API
	...
	*/
	function getIdeology(page){
		...
		$.ajax({
		   	url: 'http://api.realtimecongress.org/api/v1/bills.json?apikey=f8351c77cf7c439d9873a2b979f291d7&session=112&per_page=50&page='+page+'&sections=sponsor_id,cosponsors.bioguide_id,cosponsors.party',
			dataType: 'jsonp',	
			success: function(data){		
				...
				var pagepercent = Math.round((page / 250) * 100);
				// loading bar attempt
	...
	function getBillCountPages() {
		...
		$.ajax({
 			 ...
 			 url: 'http://api.realtimecongress.org/api/v1/bills.json?apikey=f8351c77cf7c439d9873a2b979f291d7&session=112&per_page=50',
 			 dataType: 'jsonp',
			 cache: true,
			 success: function(data) {
	...
	function getBillCount(page) {
		...
		$.ajax({
 			 url: 'http://api.realtimecongress.org/api/v1/bills.json?apikey=f8351c77cf7c439d9873a2b979f291d7&session=112&per_page=50&page='+page+'&sections=sponsor_id',
 			 dataType: 'jsonp',
			 cache: true,
			 success: function(data) {	
...
//						
	...
	function getCosponsors(legislatorKey) {
		...
		$.ajax({
 			 url: 'http://api.realtimecongress.org/api/v1/bills.json?apikey=f8351c77cf7c439d9873a2b979f291d7&session=112&per_page=50&sponsor_id='+bioguide_ids[legislatorKey]+'&sections=cosponsor_ids',
 			 dataType: 'jsonp',
			 cache: true,
			 success: function(data) {		 
